...
## Project Overview
Personal broadcast portfolio site for Tri Muhammad Jidan ("Broadcast & Livestream Operator"). Single scrolling page, content-driven. **Location:** `C:\Users\Desktop\portfolio-jidan\`. **Repo:** https://github.com/LobiuA/Portofolio.git (PRIVATE; note name is "Portofolio") — `main` pushed. **Not deployed yet.**
...
## Pending Tasks
See `docs/tasks.md`. Headline items: deploy to Vercel (import the GitHub repo); optional `next/image` optimization pass on the galleries.
...
1. Deploy to Vercel: import https://github.com/LobiuA/Portofolio at vercel.com/new (Next.js auto-detected; no env vars needed), or `vercel` CLI.
